...
|----:|:----:|:----------|
| function1_ | Вывод:
+ Список студентов группы $NUMBER, упорядоченные по посещаемости в порядке возрастания и количество посещенных ими зантий
+ Студент с лучшей посещаемостью и колличество посещенных им занятий
+ Студент с худшей посещаемостьюи колличество посещенных им занятий
| foo |
